            ...
            <main className="flex-1">
                ...
                <section className="relative">
                    <div className="relative h-[300px] md:h-[400px] w-full overflow-hidden">
                        <Image
                            src="/placeholder.svg?height=800&width=1600&query=diverse group of alumni at reunion"
                ...
                <section className="container py-12 md:py-16">
                    ...
                    >
                        <div className="space-y-6">
                            ...
                            >
                                The Horizon Academy Alumni Network connects thousands of graduates across the globe. Our alumni are
                        ...
                        >
                            <Image
                                src="/placeholder.svg?height=600&width=800&query=alumni networking event"
                    ...
                    <Tabs defaultValue="volunteer" className="w-full">
                        ...
                        <TabsContent value="volunteer">
                            ...
                            >
                                ...
                                <div className="relative h-[300px] rounded-lg overflow-hidden">
                                    <Image
                                        src="/placeholder.svg?height=500&width=700&query=alumni volunteering at school event"
                        ...
                        <TabsContent value="mentor">
                            ...
                            >
                                ...
                                <div className="relative h-[300px] rounded-lg overflow-hidden">
                                    <Image
                                        src="/placeholder.svg?height=500&width=700&query=alumni mentoring high school student"
                        ...
                        <TabsContent value="donate">
                            ...
                            >
                                ...
                                <div className="relative h-[300px] rounded-lg overflow-hidden">
                                    <Image
                                        src="/placeholder.svg?height=500&width=700&query=scholarship presentation ceremony"
...
const notableAlumni = [
    ...
    },
    {
        ...
        image: "/placeholder.svg?height=400&width=300&query=successful female tech entrepreneur headshot",
    },
    {
        name: "Michael Chen",
        graduationYear: "2010",
        ...
        image: "/placeholder.svg?height=400&width=300&query=male humanitarian aid worker portrait",
    },
]
